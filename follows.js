(function ( $ ){
	...
	*/
	...
	var defaultKey		= 'EIX7iJe1tICCkhRbUsgospz7jdUJEklYkkueLEldLKcimSjM', // Unique master Xively API key to be used as a default
		defaultFeeds	= [1992740834], // Comma separated array of Xively Feed ID numbers
							...
							xively.datastream.history(feedId, datastream.id, {duration: duration, interval: interval, limit: 1000}, function(datastreamData) {
								...
								if(datastreamData.datapoints) {
									...
									var graph = new Rickshaw.Graph( {
										...
										width: 600,
										height: 200,
										renderer: 'scatterplot',	//'area' or ' scatterplot' or 'line'
